...
abstract class Niveaux extends Application{
    ...
    int tab_bombes_i[] = new int[10];//taille à changer dans d'autres niveaux
    int tab_bombes_j[] = new int[10];
    int tab_cases_i[] = new int[1000];//pour recupere_background
    int tab_cases_j[] = new int[1000];//pour recupere_background
    int tab_cases_etat[] = new int[1000];//pour recupere_background
    int tab_coord_etat[][] = new int[10][10];
    int tab_drapeaux_i[] = new int[1000];//taille à changer dans d'autres niveaux
    int tab_drapeaux_j[] = new int[1000];
    //int tab_coord_mines[][] = new int[10][10];//taille du tableau a verif
    ...
    public int initialise_tab_coord_etat(){
        ...
        for(ic = 0; ic<10; ic++){
            for(int jc = 0; jc<10; ++jc){
                tab_coord_etat[ic][jc] = -1;//on a pas cliqué
            }
        }
        return ic;
    }
